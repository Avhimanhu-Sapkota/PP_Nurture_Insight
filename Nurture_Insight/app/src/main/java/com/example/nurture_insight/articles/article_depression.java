...
public class article_depression extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_article_depression, container, false);

        browse_therapist = (Button) view.findViewById(R.id.depression_browse_therapist);
        ...
        backButton = (ImageView) view.findViewById(R.id.depression_backButton);
