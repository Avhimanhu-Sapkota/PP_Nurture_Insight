...
public class article_selfEsteem extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_article_self_esteem, container, false);

        browse_therapist = (Button) view.findViewById(R.id.selfEsteem_browse_therapist);
        ...
        backButton = (ImageView) view.findViewById(R.id.selfEsteem_backButton);
