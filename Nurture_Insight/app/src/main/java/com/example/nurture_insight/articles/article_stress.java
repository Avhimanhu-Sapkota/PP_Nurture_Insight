...
public class article_stress extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_article_stress, container, false);

        browse_therapist = (Button) view.findViewById(R.id.stress_browse_therapist);
        ...
        backButton = (ImageView) view.findViewById(R.id.stress_backButton);
