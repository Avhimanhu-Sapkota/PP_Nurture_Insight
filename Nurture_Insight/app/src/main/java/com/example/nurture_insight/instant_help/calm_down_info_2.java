    ...
    public boolean onTouchEvent(MotionEvent touchEvent){
        switch (touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (x1 > x2){
                    Intent welcomeIntent = new Intent(calm_down_info_2.this, calm_down_info_3.class);
                    startActivity(welcomeIntent);
                }
                else if (x1 < x2){
                    Intent welcomeIntent = new Intent(calm_down_info_2.this, calm_down_info_1.class);
                    startActivity(welcomeIntent);
                }
                break;
        }
