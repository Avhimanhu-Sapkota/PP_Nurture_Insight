...
public class patient_journal_display extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_patient_journal_display, container, false);

        backButton = (ImageView) view.findViewById(R.id.patient_saved_journal_backButton);
        saved_journal_answer1 = (TextView) view.findViewById(R.id.patient_saved_journal_answer1);
        saved_journal_answer2 = (TextView) view.findViewById(R.id.patient_saved_journal_answer2);
        saved_journal_answer3 = (TextView) view.findViewById(R.id.patient_saved_journal_answer3);
        saved_journal_answer4 = (TextView) view.findViewById(R.id.patient_saved_journal_answer4);
        saved_journal_answer5 = (TextView) view.findViewById(R.id.patient_saved_journal_answer5);
        saved_journal_title = (TextView) view.findViewById(R.id.patient_saved_journal_title);
